...
<html>
 ...
 +" </nav>"
                ...
                +"<br /><form action='updateBlog.jsp' class='center' method='post'>"
                + "<input type='hidden' name='updateid' value='"+blog.getId()+"'>"
                                
                + "<input type='submit' class='btn blue' value='Update Record'/></form><br>"
                                
                  +"<form action='deleteBlog.jsp' class='center' method=''>"   
                  +"<input type='hidden' name='deleteid' value='"+blog.getId()+"'>"              
                + "<input type='submit' class='btn red center' value='Delete Record'/></form>"           
                  +"<br><a class='btn green lighten-2' style='margin-left:680px' href='allBlog.jsp'>All Recepies</a><br>"
